 ...
 * LICENSE file in the root directory of this source tree.
 */
var f=react.exports,k$1=Symbol.for("react.element"),l$1=Symbol.for("react.fragment"),m$2=Object.prototype.hasOwnProperty,n$2=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p$3={key:!0,ref:!0,__self:!0,__source:!0};
...
const useEnhancedEffect = react.exports.useLayoutEffect ;
...
function createStyled(input = {}) {
  ...
  return (tag, inputOptions = {}) => {
    ...
    const {
      ...
      options = _objectWithoutPropertiesLoose$1(inputOptions, _excluded$a);
      ...
      const expressionsWithDefaultTheme = expressions ? expressions.map(stylesArg => {
        ...
        return typeof stylesArg === 'function' && stylesArg.__emotion_real !== stylesArg ? _ref => {
          let {
            ...
            other = _objectWithoutPropertiesLoose$1(_ref, _excluded2$1);
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider({
    ...
    const {
      ...
      restThemeProp = _objectWithoutPropertiesLoose$1(themeProp, _excluded$9);
    ...
    const theme = _extends$2({}, parsedTheme, {
      components,
      colorSchemes,
      cssVarPrefix,
      vars: rootVars,
      ...
      if (key === calculatedColorScheme) {
        ...
        Object.keys(parsedScheme).forEach(schemeKey => {
          if (parsedScheme[schemeKey] && typeof parsedScheme[schemeKey] === 'object') {
            ...
            theme[schemeKey] = _extends$2({}, theme[schemeKey], parsedScheme[schemeKey]);
          } else {
...
function createPalette(palette) {
  const {
    ...
    other = _objectWithoutPropertiesLoose$2(palette, _excluded$8);
...
function createTypography(palette, typography) {
  const _ref = typeof typography === 'function' ? typography(palette) : typography,
    ...
    other = _objectWithoutPropertiesLoose$2(_ref, _excluded$7);
...
function createTransitions(inputTransitions) {
  ...
  const create = (props = ['all'], options = {}) => {
    const {
      ...
      _objectWithoutPropertiesLoose$2(options, _excluded$6);
...
function createTheme(options = {}, ...args) {
  const {
    ...
    other = _objectWithoutPropertiesLoose$2(options, _excluded$5);
  if (options.vars) {
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return /*#__PURE__*/jsxRuntime.exports.jsx(SvgIcon$1, _extends$4({
...
const InputBase = /*#__PURE__*/react.exports.forwardRef(function InputBase(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.exports.jsxs(react.exports.Fragment, {
    children: [!disableInjectingGlobalStyles && inputGlobalStyles, /*#__PURE__*/jsxRuntime.exports.jsxs(Root, _extends$4({}, rootProps, !isHostComponent(Root) && {
      ...
      children: [startAdornment, /*#__PURE__*/jsxRuntime.exports.jsx(FormControlContext.Provider, {
        value: null,
        children: /*#__PURE__*/jsxRuntime.exports.jsx(Input, _extends$4({
          ownerState: ownerState,
...
var CheckIcon = createSvgIcon( /*#__PURE__*/jsxRuntime.exports.jsx("path", {
  d: "M9 16.17 4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"
}), 'Check');

var ChevronRightIcon = createSvgIcon( /*#__PURE__*/jsxRuntime.exports.jsx("path", {
...
var ContentCopyIcon = createSvgIcon( /*#__PURE__*/jsxRuntime.exports.jsx("path", {
  d: "M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"
}), 'ContentCopy');

var EditIcon = createSvgIcon( /*#__PURE__*/jsxRuntime.exports.jsx("path", {
  d: "M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34a.9959.9959 0 0 0-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"
}), 'Edit');

var ExpandMoreIcon = createSvgIcon( /*#__PURE__*/jsxRuntime.exports.jsx("path", {
 ...
 * LICENSE file in the root directory of this source tree.
 */
var h=react.exports,n=shim.exports;function p(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}var q="function"===typeof Object.is?Object.is:p,r=n.useSyncExternalStore,t=h.useRef,u=h.useEffect,v=h.useMemo,w=h.useDebugValue;
...
function createContext() {
  ...
  const useContextStore = (selector, equalityFn) => {
    const store = react.exports.useContext(ZustandContext);
    if (!store) {
      throw new Error(
  ...
  const useStoreApi = () => {
    ...
    return react.exports.useMemo(() => ({ ...store }), [store]);
  };
  return {
    Provider,
...
const createJsonViewerStore = (props)=>create(combine({
        // provided by user
 ...
 */ function useClipboard({ timeout =2000  } = {}) {
    ...
    const copyTimeout = react.exports.useRef(null);
    const handleCopyResult = react.exports.useCallback((value)=>{
    ...
    const copy = react.exports.useCallback((path, value)=>{
...
function useIsCycleReference(path, value) {
    ...
    return react.exports.useMemo(()=>isCycleReference(rootValue, path, value), [
        path,
        value,
        rootValue
    ]);
...
function useInspect(path, value, nestedIndex) {
    ...
    const [inspect, set] = react.exports.useState(()=>{
    ...
    const setInspect = react.exports.useCallback((apply)=>{
        set((oldState)=>{
...
const DataBox = styled$1((props)=>/*#__PURE__*/ jsx(Box$1, {
        component: "div",
        ...props
    }))`
  display: inline-block;
...
function createEasyType(type, renderValue, config) {
    ...
    const EasyTypeEditor = ({ value , setValue  })=>{
        ...
        return /*#__PURE__*/ jsx(InputBase$1, {
            value: `${value}`,
            onChange: react.exports.useCallback((event)=>{
...
Object.defineProperty(findOrCreate$1, "__esModule", { value: true });
findOrCreate$1.findOrCreate = void 0;
/**
...
findOrCreate$1.findOrCreate = findOrCreate;

var asArrays = {};

Object.defineProperty(asArrays, "__esModule", { value: true });
asArrays.asArraysFactory = void 0;
/**
...
asArrays.asArraysFactory = asArraysFactory;

var asEntries = {};

Object.defineProperty(asEntries, "__esModule", { value: true });
asEntries.asEntriesFactory = void 0;
/**
...
asEntries.asEntriesFactory = asEntriesFactory;

var asMap = {};

Object.defineProperty(asMap, "__esModule", { value: true });
asMap.asMapFactory = void 0;
/**
...
asMap.asMapFactory = asMapFactory;

var asObject = {};

Object.defineProperty(asObject, "__esModule", { value: true });
asObject.asObjectFactory = void 0;
/**
...
asObject.asObjectFactory = asObjectFactory;

var asTuples = {};

Object.defineProperty(asTuples, "__esModule", { value: true });
asTuples.asTuplesFactory = void 0;
/**
...
asTuples.asTuplesFactory = asTuplesFactory;

var keys = {};

Object.defineProperty(keys, "__esModule", { value: true });
keys.keysFactory = void 0;
/**
 * Create a TuplesCollector for the given grouping.
 *
 * @param groups The grouping.
...
const deep_eql_1 = __importDefault(deepEql.exports);
const find_or_create_js_1 = findOrCreate$1;
const as_arrays_js_1 = asArrays;
const as_entries_js_1 = asEntries;
const as_map_js_1 = asMap;
const as_object_js_1 = asObject;
const as_tuples_js_1 = asTuples;
const keys_js_1 = keys;
// UTILITY METHODS
/**
...
const PreObjectType = (props)=>{
    ...
    const isArray = react.exports.useMemo(()=>Array.isArray(props.value), [
        props.value
    ]);
    const sizeOfValue = react.exports.useMemo(()=>props.inspect ? inspectMetadata(props.value) : '', [
        props.inspect,
        props.value
    ]);
    ...
    return /*#__PURE__*/ jsxs(Box$1, {
        ...
        children: [
            ...
            displayObjectSize ? /*#__PURE__*/ jsx(Box$1, {
                component: "span",
                sx: {
                    pl: 0.5,
                    fontStyle: 'italic',
...
const ObjectType = (props)=>{
    ...
    const isTrap = useIsCycleReference(props.path, props.value);
    const [displayLength, setDisplayLength] = react.exports.useState(useJsonViewerStore((store)=>store.maxDisplayLength));
    const objectSortKeys = useJsonViewerStore((store)=>store.objectSortKeys);
    const elements = react.exports.useMemo(()=>{
        if (!props.inspect) {
            return null;
        }
        ...
        if (Array.isArray(value)) {
            ...
            const elements2 = dist.group(value).by((_, index)=>Math.floor(index / groupArraysAfterLength)).asArrays();
...
const createTypeRegistryStore = ()=>create(combine({
        registry: []
    }, (set)=>({
...
function useTypeComponents(value, path) {
    ...
    return react.exports.useMemo(()=>matchTypeComponents(value, path, registry), [
        value,
        path,
        registry
    ]);
...
function predefined() {
    ...
    function registerType(dataType) {
        ...
        dataType.Component = /*#__PURE__*/ react.exports.memo(dataType.Component, compare);
        if (dataType.Editor) {
            dataType.Editor = /*#__PURE__*/ react.exports.memo(dataType.Editor, function compare(prevProps, nextProps) {
                return Object.is(prevProps.value, nextProps.value);
            });
        }
        if (dataType.PreComponent) {
            dataType.PreComponent = /*#__PURE__*/ react.exports.memo(dataType.PreComponent, compare);
        }
        if (dataType.PostComponent) {
            dataType.PostComponent = /*#__PURE__*/ react.exports.memo(dataType.PostComponent, compare);
        }
        types.push(dataType);
    }
    registerType({
        is: (value)=>typeof value === 'boolean',
        ...createEasyType('bool', ({ value  })=>/*#__PURE__*/ jsx(Fragment, {
    ...
    registerType({
        ...
        ...createEasyType('date', ({ value  })=>/*#__PURE__*/ jsx(Fragment, {
    ...
    registerType({
        ...
        ...createEasyType('string', (props)=>{
            const [showRest, setShowRest] = react.exports.useState(false);
    ...
    registerType({
        ...
        ...createEasyType('float', ({ value  })=>/*#__PURE__*/ jsx(Fragment, {
                children: `${value}`
            }), {
            colorKey: 'base0B',
    ...
    registerType({
        is: (value)=>typeof value === 'number' && isInt(value),
        ...createEasyType('int', ({ value  })=>/*#__PURE__*/ jsx(Fragment, {
                children: `${value}`
            }), {
            colorKey: 'base0F',
    ...
    registerType({
        ...
        ...createEasyType('bigint', ({ value  })=>/*#__PURE__*/ jsx(Fragment, {
                children: `${value}n`
            }), {
            colorKey: 'base0F',
...
const IconBox = styled$1((props)=>/*#__PURE__*/ jsx(Box$1, {
        ...props,
        component: "span"
    }))`
  cursor: pointer;
...
const DataKeyPair = (props)=>{
    ...
    const editable = react.exports.useMemo(()=>{
    ...
    const [tempValue, setTempValue] = react.exports.useState(typeof value === 'function' ? ()=>value : value);
    const depth = path.length;
    const key = path[depth - 1];
    const hoverPath = useJsonViewerStore((store)=>store.hoverPath);
    const isHover = react.exports.useMemo(()=>{
    ...
    const actionIcons = react.exports.useMemo(()=>{
        if (editing) {
    ...
    const downstreamProps = react.exports.useMemo(()=>({
            path,
            inspect,
            setInspect,
            value
    ...
    return /*#__PURE__*/ jsxs(Box$1, {
        ...
        onMouseEnter: react.exports.useCallback(()=>setHover(path, nestedIndex), [
            setHover,
            path,
            nestedIndex
        ]),
        children: [
            /*#__PURE__*/ jsxs(DataBox, {
                ...
                onClick: react.exports.useCallback((event)=>{
                ...
                children: [
                    ...
                    isRoot ? rootName !== false ? quotesOnKeys ? /*#__PURE__*/ jsxs(Fragment, {
                        ...
                        ...downstreamProps
                    }) : nestedIndex === undefined && (isNumberKey ? /*#__PURE__*/ jsx(Box$1, {
                        component: "span",
                        style: {
...
function useThemeDetector() {
    const [isDark, setIsDark] = react.exports.useState(false);
    react.exports.useEffect(()=>{
        const listener = (e)=>{
            setIsDark(e.matches);
        };
 ...
 */ const JsonViewerInner = (props)=>{
    ...
    const onceRef = react.exports.useRef(true);
    const predefinedTypes = react.exports.useMemo(()=>predefined(), []);
    ...
    return /*#__PURE__*/ jsx(Paper$1, {
        ...
        onMouseLeave: react.exports.useCallback(()=>{
            setHover(null);
        }, [
            setHover
        ]),
...
const JsonViewer$1 = function JsonViewer(props) {
    ...
    var _props_theme;
    const themeType = react.exports.useMemo(()=>props.theme === 'auto' ? isAutoDarkTheme ? 'light' : 'dark' : (_props_theme = props.theme) !== null && _props_theme !== void 0 ? _props_theme : 'light', [
        isAutoDarkTheme,
        props.theme
    ]);
    const theme = react.exports.useMemo(()=>{
...
class JsonViewer {
    render(el) {
        ...
        if (container) {
            ...
            this.root.render(/*#__PURE__*/ jsx(JsonViewer$1, {
                ...this.props
            }));
        }
    }
...
JsonViewer.Component = JsonViewer$1;
